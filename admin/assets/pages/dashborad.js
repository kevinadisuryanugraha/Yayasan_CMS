...
!(function ($) {
  ...
  //creates line chart
  (Dashboard.prototype.createLineChart = function (
    element,
    data,
    xkey,
    ykeys,
    ...
    (Dashboard.prototype.init = function () {
      // Only initialize charts if their container elements exist

      //create line chart - only if element exists
      if (document.getElementById("multi-line-chart")) {
        ...
        this.createLineChart(
          ...
          ["#007BFF", "#00bcd2", "#e785da"]
        );
      }

      //creating area chart - only if element exists
      ...
      //creating donut chart - only if element exists
      if (document.getElementById("morris-donut-chart")) {
        ...
        this.createDonutChart("morris-donut-chart", $donutData, [
          "#40a4f1",
          "#5b6be8",
          "#c1c5e2",
        ]);

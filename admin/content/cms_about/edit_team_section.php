...
// Fetch Existing Data
$query = "SELECT * FROM about_team_section WHERE id = $id";
...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        $update_query = "UPDATE about_team_section SET 
            subtitle = '$subtitle', 
            title = '$title', 
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Edit Header Tim</h4>
            </div>
        </div>
    </div>

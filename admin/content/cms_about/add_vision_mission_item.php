...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        $query = "INSERT INTO about_vision_mission_items (icon, title, description, list_items, sort_order) VALUES ('$icon', '$title', '$description', '$list_items', $sort_order)";
        if (mysqli_query($conn, $query)) {
            $_SESSION['alert'] = ['type' => 'success', 'title' => 'Berhasil!', 'message' => 'Item berhasil ditambahkan'];
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Tambah Item Baru</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card m-b-30">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Formulir Item</h4>
                    <p class="text-muted m-b-30 font-14">
                        Isi form di bawah ini untuk menambahkan kartu Visi, Misi, atau poin kunci lainnya.
                    </p>
                    ...
                    <form method="POST" id="addItemForm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <small class="form-text text-muted mt-2"><i class="mdi mdi-information-outline"></i> Visualisasi untuk kartu ini.</small>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="sort_order"
                                    value="<?php echo intval($form_data['sort_order'] ?? 0); ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-9 offset-sm-3">
                                <button type="submit" class="btn btn-primary btn-lg"><i
                                        class="mdi mdi-content-save"></i> Simpan Data</button>
                ...
                <div class="card-body text-center">
                    <div class="p-4 bg-light rounded vm-card-preview">
                        <div class="vm-card-icon mb-3">
                            <i id="preview-icon"
                                class="<?php echo htmlspecialchars($form_data['icon'] ?? 'icofont-eye-open'); ?> text-primary"
                                style="font-size: 40px;"></i>
                        </div>
                        <h4 id="preview-title" class="mb-3" style="font-weight: 700;">
                            <?php echo htmlspecialchars($form_data['title'] ?? 'Judul Item'); ?>
                        </h4>
...
<script>
    $(document).ready(function () {
        ...
        $('#title').on('input', function () {
            $('#preview-title').text($(this).val() || 'Judul Item');
        });
        ...
        $('.btn-cancel').on('click', function (e) {
            ...
            if ($('#title').val() || $('#description').val() || $('#list_items').val()) {
                Swal.fire({

...
$query = mysqli_query($conn, "SELECT * FROM events_header WHERE id = 1 LIMIT 1");
$header = mysqli_fetch_assoc($query);

// Jika belum ada data, buat default
if (!$header) {
    mysqli_query($conn, "INSERT INTO events_header (id, subtitle, title) VALUES (1, 'Acara Mendatang', 'Bergabunglah dalam Acara Kami')");
    $query = mysqli_query($conn, "SELECT * FROM events_header WHERE id = 1 LIMIT 1");
    $header = mysqli_fetch_assoc($query);
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Simpan ke database
    if (empty($errors)) {
        $update = "UPDATE events_header SET subtitle = '$subtitle', title = '$title' WHERE id = 1";

        if (mysqli_query($conn, $update)) {
            $_SESSION['alert'] = ['type' => 'success', 'title' => 'Berhasil!', 'message' => 'Header acara berhasil diperbarui'];
            header("Location: ?page=edit_events_header");
            exit;
        } else {
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Edit Header Acara</h4>
            </div>
        </div>
    </div>
            ...
            <div class="card m-b-30 bg-light">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-9">
                            <h5 class="mb-2"><i class="mdi mdi-help-circle-outline text-primary mr-2"></i>Apa itu Header Acara?</h5>
                            <p class="mb-0 text-muted">
                                <strong>Header Acara</strong> adalah teks judul dan subjudul yang ditampilkan di bagian atas 
                                section Acara pada halaman utama. Header ini membantu pengunjung memahami konten acara yang akan ditampilkan.
                            </p>
                        </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <p class="text-muted m-b-30 font-14">Ubah judul dan subjudul section acara</p>
                    ...
                    <form method="POST" action="" id="headerForm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="subtitle" name="subtitle"
                                ...
                                placeholder="Contoh: Acara Mendatang" maxlength="150">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title"
                                ...
                                placeholder="Contoh: Bergabunglah dalam Acara Kami" required minlength="5" maxlength="255">
                            <small class="form-text text-muted">
                                <i class="mdi mdi-information-outline"></i> Judul besar section acara (wajib, 5-255 karakter)
                            </small>
                        </div>
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    <div class="text-center p-4 bg-light rounded">
                        <p class="text-primary mb-2" style="font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">
                            <?php echo htmlspecialchars($header['subtitle'] ?? 'Acara Mendatang'); ?>
                        </p>
                        <h4 class="mb-0 font-weight-bold">
                            <?php echo htmlspecialchars($header['title'] ?? 'Bergabunglah dalam Acara Kami'); ?>
                        </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="card m-b-30 border-primary">
                ...
                <div class="card-body">
                    <ul class="small mb-0">
                        ...
                        <li class="mb-0"><strong>Tips:</strong> Gunakan kalimat ajakan</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card m-b-30 border-info">
                ...
                <div class="card-body">
                    <div class="mb-3 p-2 bg-light rounded small">
                        <strong class="text-primary">Subjudul:</strong> Acara Mendatang<br>
                        <strong>Judul:</strong> Bergabunglah Bersama Kami
                    </div>
                    <div class="p-2 bg-light rounded small">
                        <strong class="text-primary">Subjudul:</strong> Jadwal Kegiatan<br>
                        <strong>Judul:</strong> Acara Islami Terbaru
                    </div>
                </div>
            </div>
            ...
            <div class="card m-b-30 border-secondary">
                ...
                <div class="card-body">
                    <a href="?page=events" class="btn btn-outline-secondary btn-block mb-2">
                        <i class="mdi mdi-view-list"></i> Kelola Acara
                    </a>

...
$query = mysqli_query($conn, "SELECT * FROM service_header WHERE id = 1 LIMIT 1");
$header = mysqli_fetch_assoc($query);

// Jika belum ada data, buat default
if (!$header) {
    mysqli_query($conn, "INSERT INTO service_header (id, subtitle, title) VALUES (1, 'Layanan Kami', 'Apa yang Kami Tawarkan')");
    $query = mysqli_query($conn, "SELECT * FROM service_header WHERE id = 1 LIMIT 1");
    $header = mysqli_fetch_assoc($query);
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Simpan ke database
    if (empty($errors)) {
        $update = "UPDATE service_header SET title = '$title', subtitle = '$subtitle', updated_at = NOW() WHERE id = 1";

        if (mysqli_query($conn, $update)) {
            $_SESSION['alert'] = ['type' => 'success', 'title' => 'Berhasil!', 'message' => 'Header layanan berhasil diperbarui'];
            header("Location: ?page=edit_service_header");
            exit;
        } else {
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Edit Header Layanan</h4>
            </div>
        </div>
    </div>
            ...
            <div class="card m-b-30 bg-light">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-9">
                            <h5 class="mb-2"><i class="mdi mdi-help-circle-outline text-primary mr-2"></i>Apa itu Header Layanan?</h5>
                            <p class="mb-0 text-muted">
                                <strong>Header Layanan</strong> adalah teks judul dan subjudul yang ditampilkan di bagian atas 
                                section Layanan pada halaman utama. Header ini membantu pengunjung memahami konten yang akan mereka lihat.
                            </p>
                        </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <p class="text-muted m-b-30 font-14">Ubah judul dan subjudul section layanan</p>
                    ...
                    <form method="POST" action="" id="headerForm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="subtitle" name="subtitle"
                                ...
                                placeholder="Contoh: Layanan Kami, Apa yang Kami Tawarkan" maxlength="100">
                            <small class="form-text text-muted">
                                <i class="mdi mdi-information-outline"></i> Teks kecil di atas judul utama (opsional, maks 100 karakter)
                            </small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title"
                                ...
                                placeholder="Contoh: Layanan Terbaik Untuk Anda" required minlength="5" maxlength="255">
                            <small class="form-text text-muted">
                                <i class="mdi mdi-information-outline"></i> Judul besar section layanan (wajib, 5-255 karakter)
                            </small>
                        </div>
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    <div class="text-center p-4 bg-light rounded">
                        <p class="text-primary mb-2" style="font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">
                            <?php echo htmlspecialchars($header['subtitle'] ?? 'Layanan Kami'); ?>
                        </p>
                        <h4 class="mb-0 font-weight-bold">
                            <?php echo htmlspecialchars($header['title'] ?? 'Apa yang Kami Tawarkan'); ?>
                        </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="card m-b-30 border-info">
                ...
                <div class="card-body">
                    <div class="mb-3 p-2 bg-light rounded small">
                        <strong class="text-primary">Subjudul:</strong> Layanan Kami<br>
                        <strong>Judul:</strong> Solusi Terbaik Untuk Kebutuhan Anda
                    </div>
                    <div class="p-2 bg-light rounded small">
                        <strong class="text-primary">Subjudul:</strong> Kenapa Memilih Kami<br>
                        <strong>Judul:</strong> Kami Hadir Untuk Membantu
                    </div>
                </div>
            </div>
            ...
            <div class="card m-b-30 border-secondary">
                ...
                <div class="card-body">
                    <a href="?page=services" class="btn btn-outline-secondary btn-block mb-2">
                        <i class="mdi mdi-view-list"></i> Kelola Layanan
                    </a>
                    <a href="?page=add_service" class="btn btn-outline-success btn-block">

            ...
            <div class="card m-b-30 bg-light">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h5 class="mb-2"><i class="mdi mdi-help-circle-outline text-primary mr-2"></i>Apa itu Kampanye Utama?</h5>
                            <p class="mb-0 text-muted">
                                <strong>Kampanye Utama</strong> adalah area donasi yang ditampilkan secara menonjol di halaman utama website.
                                Di sini Anda dapat mengatur judul kampanye, gambar latar, target donasi, dan progress donasi yang sudah terkumpul.
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span class="badge badge-<?php echo ($campaign['is_active'] ?? 1) ? 'success' : 'secondary'; ?> p-2">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data" id="campaignForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title"
                                ...
                                placeholder="Contoh: Bantu Saudara Kita yang Membutuhkan">
                            <small class="form-text text-muted">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                ...
                                <strong>Format:</strong> JPG, PNG, GIF, WEBP | <strong>Maks:</strong> 3MB | <strong>Ideal:</strong> 1920x800px
                            </small>
                            <div id="imagePreview" class="mt-2" style="display:none;">
                                <small class="text-success d-block mb-1"><i class="mdi mdi-check-circle mr-1"></i>Gambar Baru (Preview):</small>
                                <img id="previewImg" src="" alt="Preview" class="img-fluid rounded shadow-sm" style="max-height: 150px;">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="goal_amount">Target Donasi (Rp) <span class="text-danger">*</span></label>
            ...
            <div class="card m-b-30 border-success">
                ...
                <div class="card-body">
                    <div class="text-center mb-3">
                        <h3 class="text-success mb-0">Rp <?php echo number_format($campaign['amount_raised'] ?? 0, 0, ',', '.'); ?></h3>
                        <small class="text-muted">terkumpul dari target Rp <?php echo number_format($campaign['goal_amount'] ?? 0, 0, ',', '.'); ?></small>
                    </div>

                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="footer-middle-item">
                        ...
                        <div class="fm-item-content">
                            <p><?php echo htmlspecialchars($site_settings['footer_text'] ?? 'We are a nonprofit organization dedicated to serving the community with faith, compassion, and integrity.'); ?></p>
                    ...
                    <div class="footer-middle-item">
                        ...
                        <div class="fm-item-content">
                            <ul class="footer-links">
                                ...
                                <li><a href="index.php?page=gallery"><i class="icofont-double-right"></i> Gallery</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer-bottom-content text-center py-3">
                        <p><?php echo htmlspecialchars($site_settings['copyright_text'] ?? '© ' . date('Y') . ' ' . ($site_settings['site_name'] ?? 'Hafsa') . ' - All Rights Reserved'); ?></p>
                    </div>
                </div>
            </div>
        </div>
